...
// The dbt namespace and its types live in ./dbt.ts. Pulled in locally
// for the class wiring below and re-exported at the package-entry level
...
export class AgentOs {
	...
	/**
	 * dbt operations namespace. See `AgentOsDbt` for the full method
	 * surface. Available whenever the VM was booted with
	 * `python: { dbt: true }`.
	 */
