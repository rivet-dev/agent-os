 ...
 *
 * Boots a fully virtualized VM (via the sidecar) and runs guest Node
...
/**
 * Commands vendored into the published `@rivet-dev/agentos-core` package by
 ...
 * of how the sidecar binary ships inside `@rivet-dev/agentos-sidecar`.
 */
...
export interface NodeRuntimeCreateOptions {
	 ...
	 * `@rivet-dev/agentos-core` package (published installs).
	 */
	commandsDir?: string;
	/**
	...
	/**
	 * Existing sidecar process to use for this runtime. Omit this to use
