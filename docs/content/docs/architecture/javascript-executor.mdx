...
environment, see [JavaScript](/agentos/docs/javascript). For WebAssembly modules
that suspend across JavaScript promises inside V8, see
[Async WebAssembly & JSPI](/agentos/docs/architecture/async-webassembly).
