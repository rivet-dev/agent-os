use super::*;
use agentos_vm_kernel::kernel::{WaitPidEvent, WaitPidFlags};
use agentos_vm_kernel::process_runtime::ProcessExit;
use agentos_vm_kernel::process_table::{ProcessResourceLimit, ProcessResourceLimitKind};
use agentos_vm_kernel::resource_accounting::{
...
fn wait_result_value(
    transition: Option<agentos_vm_kernel::kernel::WaitPidDetailedResult>,
) -> Result<Value, HostServiceError> {
