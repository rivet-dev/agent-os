    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::RuntimeUnavailable => write!(
                f,
                "guest Python execution is unavailable: this build of agentos-executor-python-v8-pyodide \
...
mod tests {
    ...
    use agentos_executor_contract::backend::HostCallReply;
    ...
    fn downstream_claim_error_preserves_python_pending_state() {
        ...
        let error = super::claim_pending_vfs_rpc(&pending, 42, || {
            Err(agentos_executor_contract::backend::HostServiceError::new(
                "EIO",
