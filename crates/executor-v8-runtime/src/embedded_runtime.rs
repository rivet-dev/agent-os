...
impl EmbeddedV8Runtime {
    ...
    fn register_session_with_capacity(
        ...
        session_id: &str,
        capacity: usize,
        resources: Arc<agentos_driver_tokio::accounting::ResourceLedger>,
    ) -> io::Result<(
        RuntimeEventOutputReceiver,
        EmbeddedV8SessionOutputRegistration,
    )> {
    ...
    pub fn dispatch_create_session_with_runtime(
        ...
        session_runtime: agentos_driver_tokio::DriverHandle,
...
pub fn spawn_embedded_runtime_ipc(
    ...
    let join_handle = thread::Builder::new()
        .name(String::from("agentos-executor-v8-runtime"))
        .spawn(move || {
...
mod tests {
    ...
    fn embedded_runtime_uses_configured_executor_and_output_bounds() {
        ...
        let runtime_context = agentos_driver_tokio::TokioDriver::process(&config)
    ...
    fn in_process_session_creation_preserves_vm_resource_scope() {
        ...
        let vm_resources = Arc::new(agentos_driver_tokio::accounting::ResourceLedger::child(
            "embedded-runtime-vm",
            [
                (
                    agentos_driver_tokio::accounting::ResourceClass::BridgeCalls,
                    agentos_driver_tokio::accounting::ResourceLimit::new(
                        1,
                        "limits.reactor.maxBridgeCalls",
                    ),
                ),
                (
                    agentos_driver_tokio::accounting::ResourceClass::HandleCommands,
                    agentos_driver_tokio::accounting::ResourceLimit::new(
                        2,
                ...
                (
                    agentos_driver_tokio::accounting::ResourceClass::ReadyHandles,
                    agentos_driver_tokio::accounting::ResourceLimit::new(
                        2,
                ...
                (
                    agentos_driver_tokio::accounting::ResourceClass::Timers,
                    agentos_driver_tokio::accounting::ResourceLimit::new(
                        2,
