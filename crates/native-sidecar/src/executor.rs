...
//!
//! Concrete executors remain independent crates. The native sidecar owns the
...
use agentos_v8_runtime::adapter_host::V8SessionHandle;
...
#[cfg(feature = "wasm-wasmtime")]
pub use agentos_executor_wasm_wasmtime::run_worker_entry as run_wasmtime_thread_worker;
#[cfg(any(
    feature = "node-v8",
    feature = "python-v8-pyodide",
    feature = "wasm-v8"
))]
pub use agentos_v8_runtime::adapter_host as v8_host;
#[cfg(any(
    feature = "node-v8",
    feature = "python-v8-pyodide",
    feature = "wasm-v8"
))]
pub use agentos_v8_runtime::adapter_runtime as v8_runtime;
#[cfg(feature = "node-v8")]
pub use agentos_v8_runtime::asset_cache::bundled_typescript_assets;
...
pub use agentos_v8_runtime::javascript;
#[cfg(any(
    feature = "node-v8",
    feature = "python-v8-pyodide",
    feature = "wasm-v8"
))]
pub use agentos_v8_runtime::javascript::JavascriptSyncRpcResponder;
#[cfg(any(
    feature = "node-v8",
    feature = "python-v8-pyodide",
    feature = "wasm-v8"
...
pub const WASMTIME_THREAD_WORKER_ARGUMENT: &str = "--agentos-wasmtime-thread-worker";
