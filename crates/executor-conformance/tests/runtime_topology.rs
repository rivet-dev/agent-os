...
fn execution_subsystems_do_not_lookup_or_build_runtime_topology() {
    let sources = [
        ...
        (
            "python.rs",
            include_str!("../../executor-python-v8-pyodide/src/lib.rs"),
        ),
...
fn supplied_vm_runtime_is_forwarded_to_per_execution_paths() {
    ...
    let python = include_str!("../../executor-python-v8-pyodide/src/lib.rs");
    ...
    let wasm = include_str!("../../executor-wasm-v8/src/lib.rs");
