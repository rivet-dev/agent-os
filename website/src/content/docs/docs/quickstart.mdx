...
1. **Install**
   ...
   - **@agentos-software/pi** — [Pi](https://github.com/earendil-works/pi) coding agent. [Claude Code](/docs/agents/claude), [Codex](/docs/agents/codex), and [OpenCode](/docs/agents/opencode) install the same way.
