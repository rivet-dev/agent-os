...
- `@rivet-dev/vercel-world`: Runs Eve workflows on [Rivet World](https://workflow-sdk.dev/).
...
[Read the Rivet World documentation →](https://rivet.dev/integrations/vercel-workflows)
