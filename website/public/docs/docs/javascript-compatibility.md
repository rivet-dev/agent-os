...
- Network builtins obey the VM [permission policy](/docs/permissions).
...
- Console/stream output flows through the bounded process-output path — see
  [Processes & Shells](/docs/processes).

Back to the [JavaScript guide](/docs/javascript) for TypeScript, packages,
